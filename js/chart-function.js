...
==================================*/    
    ...
    function chart(){
      /* Layout 1 Token Chat */
      var colors = ['#7d7d7d', '#d47c0c', '#fbbd18', '#8f93e1'];
      var labels = ["Marketing 3%", "Max Transaction 2%", "Liquidity 5%", "Max Wallet 4%"];
      var data = [3, 2, 5, 4];
      var bgColor = colors;
      var dataChart = {
        labels: labels,
      ...
      legendHolder.innerHTML = legend;
       ...
       /* Layout 2 Token Chat */
      var layout2colors = ['#7d7d7d', '#d47c0c', '#fbbd18', '#8f93e1'];
      var layout2labels = ["Marketing 3%", "Max Transaction 2%", "Liquidity 5%", "Max Wallet 4%"];
      var layout2data = [3, 2, 5, 4];
      var layout2data2 = [3, 2, 5, 4];
